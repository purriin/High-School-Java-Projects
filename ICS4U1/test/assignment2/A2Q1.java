...
public class A2Q1 {
    ...
    public static void outputFrequencies(ArrayList scarletLines, int[] frequency, String[] letters) throws IOException{
        ...
        writer.println ("\n" + "Top 5 Letters:" + "\n" + letters[index[0]] + " = " + max[0] + "\n" + letters[index[1]] + " = " + max[1]);
        writer.println (letters[index[2]] + " = " + max[2] + "\n" + letters[index[3]] + " = " + max[3] + "\n" + letters[index[4]] + " = " + max[4]);
        
        writer.println ("\n" + "Bottom 5 Letters:" + "\n" + letters[index[21]] + " = " + max[21] + "\n" + letters[index[22]] + " = " + max[22]);
        writer.println (letters[index[23]] + " = " + max[23] + "\n" + letters[index[24]] + " = " + max[24] + "\n" + letters[index[25]] + " = " + max[25]);
        writer.close();
