...
/**
  * Name: Shannon Jones
  * Date: 2020-10-14
  * Description: This program scans 
...
public class A2Q2 {
    ...
    public static ArrayList readText(ArrayList lines) throws IOException {
        Scanner reader = new Scanner (new File("C:\\Java Folder\\raw_marks.txt"));
    ...
    public static void outputReport(ArrayList marks, ArrayList names, ArrayList averageS, ArrayList averageC) throws IOException{
        ...
        for (int i = 0; i < 20; i++) {
            fileName = "C:\\Java Folder\\" + names.get(lastName) + ".txt";
